...
{
    public partial class ext_leak_prompt : Form
    {
        private static string user_input;
        private static string exp_input;
        private static string extleak_value;
        ...
        public string Extleak_value
        {
            get { return extleak_value; }

            set { extleak_value = value; }
        }

        public ext_leak_prompt()
        {
            InitializeComponent();
        }

        private void ext_leak_prompt_Load(object sender, EventArgs e)
        {
        ...
        private void button_confirm_Click(object sender, EventArgs e)
        {
            if (Convert.ToSingle(num_input.Text) > 1.1 && Convert.ToSingle(num_input.Text) < 1.9)
            {
                ...
                Extleak_value = User_input + "E-" + Exp_input;
                this.DialogResult = DialogResult.OK;
            }
            else
                MessageBox.Show("Please enter the correct external leakrate value.", "WARNING");
        }
